...
import { generateQtiZip } from "./services/qtiService.js";
import { Instructions } from "./components/Instructions.js";
import { DownloadIcon, LoaderIcon, AlertTriangleIcon } from "./components/icons.js";
      ...
      <div className="w-full max-w-4xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Convert plain text to a Canvas-ready question bank with feedback.
          </p>
        </header>
        ...
        <main className="space-y-6">
          ...
          {error && (
            <div
              className="bg-red-900/50 border border-red-700 text-red-300 px-4 py-3 rounded-lg flex items-center"
              role="alert"
            >
          ...
          <div className="flex flex-col space-y-2">
            <label htmlFor="raw-text" className="font-semibold text-gray-300">
              1. Your Formatted Questions
            </label>
            <textarea
              id="raw-text"
              value={text}
          ...
          <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 space-y-4 md:space-y-0 md:flex md:items-center md:justify-between md:gap-4">
            <div className="flex-grow">
              <label htmlFor="bank-title" className="block text-sm font-medium text-gray-300 mb-1">
                2. Question Bank Title
              </label>
              <input
                id="bank-title"
                type="text"
